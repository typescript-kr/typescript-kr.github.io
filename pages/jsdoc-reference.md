...
컴파일러는 코드가 작동할 수 있을 정도의 내용이 있다면 보통 `this`의 타입을 파악할 수 있습니다. 그렇지 않은 경우, `@this`를 사용하여 명확하게 `this`의 타입을 지정할 수 있습니다:
...
`@extends`는 클래스에서만 작동합니다. 현재까지, 생성자 함수가 클래스를 확장할 수 있는 방법은 없습니다.
